...
const SNAPSHOT = [
  ...
  { name: 'get_cross_vault_links', description: 'Find legacy unresolved-wikilink candidates, inventory labeled Markdown links to native obsidian://open note URIs, and compose eligible declarations into a typed read-only cross-vault graph overlay. Per-vault ranking is unchanged.' },
